...
export default function Contact() {
  ...
  return  <section id='Contact'>
    ...
    <form onSubmit={handleSubmit} className='py-5 d-flex  mt-5 flex-column justify-content-center align-items-center mt-free bg-dark rounded-3 lighty'>
    <h1 className='seaction-header mb-5'>Contact Us</h1>
